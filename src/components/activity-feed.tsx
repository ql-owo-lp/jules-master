...
// Memoized list component to prevent re-renders of the entire list when
// parent props like countdown or lastUpdatedAt change.
// This significantly improves performance when polling is active.
const ActivityList = memo(({ activities }: { activities: Activity[] }) => {
  return (
