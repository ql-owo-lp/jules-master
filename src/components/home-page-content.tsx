...
export function HomePageContent() {
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [isClient, apiKey, hasEnvApiKey, sessionListPollInterval]);


  // Countdown timer
  useEffect(() => {
    if (!isClient || (!apiKey && !hasEnvApiKey) || sessionListPollInterval <= 0) return;
  ...
  }, [isClient, apiKey, hasEnvApiKey, sessionListPollInterval, lastUpdatedAt]);
  ...
  const hasJulesApiKey = !!(hasEnvApiKey || apiKey);
